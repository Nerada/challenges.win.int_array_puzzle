...
namespace IntArrayPuzzle.tests
{
    ...
    public class HighestNumberCalculatorT
    {
        ...
        {
            Assert.AreEqual(1, _calculator.Calculate(new List<int> {-1, 0, 1}));
        }

        [TestMethod]
        public void Example_3_test()
        {
            Assert.AreEqual(2, _calculator.Calculate(new List<int> {1, 1}));
        }

        [TestMethod]
        public void SingleValue_test()
        {
            Assert.AreEqual(42, _calculator.Calculate(new List<int> {42}));
        }
